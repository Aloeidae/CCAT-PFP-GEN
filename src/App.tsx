...
const t = {
  EN: {
    ...
    slogans: [
      ...
      "From each according to his ability, to each according to his naps...",
      "The purr-letariat is rising, comrade...",
      "Redistributing the treats equally among all comrades...",
      "Collectivizing the yarn reserves of the motherland...",
      ...
      "No comrade shall go without a warm ushanka. It is the law...",
      "Sharpening the claws of the revolution...",
    ],
  },
  RU: {
    ...
    slogans: [
      ...
      "Мур-летариат восстаёт, товарищ...",
      "Поровну распределяем вкусняшки между товарищами...",
      "Коллективизируем запасы пряжи родины...",
      ...
      "Ни один товарищ не останется без тёплой ушанки. Таков закон...",
      "Точим когти славной революции...",
    ],
  }
};
